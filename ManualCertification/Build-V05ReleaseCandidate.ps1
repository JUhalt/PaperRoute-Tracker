...
<#
.SYNOPSIS
Build, test, and verify a local v0.5 candidate without installing or publishing it.
.EXAMPLE
pwsh -NoProfile -File .\ManualCertification\Build-V05ReleaseCandidate.ps1 -OutputDirectory .\artifacts\v0.5.0-candidate-01
.NOTES
...
param(
    ...
    [ValidatePattern('^0\.5\.0(?:-rc\.[1-9][0-9]*)?$')]
