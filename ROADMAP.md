...
**September 12 release preparation checkpoint:** readiness, packet assembly, explicit file-integrity checks, and connected submission navigation are implemented in the development branch. Version metadata, candidate notes, and user documentation are aligned for v0.4.0. The local candidate passed 478 tests without failures or skips and built without warnings or errors; [independent CI passed](https://github.com/JUhalt/PaperRoute-Tracker/actions/runs/34706123322). Installer, full update package, and portable ZIP versions, payloads, local feeds, and checksums were verified.

The [candidate notes](https://github.com/JUhalt/PaperRoute-Tracker/blob/021cd0afdda1c66d21fc7ad78119e2012365983b/docs/releases/0.4.0.md), [packaging procedure](https://github.com/JUhalt/PaperRoute-Tracker/blob/021cd0afdda1c66d21fc7ad78119e2012365983b/ManualCertification/v0.4-Release-Packaging.md), and [checkpoint evidence](https://github.com/JUhalt/PaperRoute-Tracker/blob/021cd0afdda1c66d21fc7ad78119e2012365983b/ManualCertification/v0.4-Development-Checkpoint.md) separate completed checks from release certification. Native Windows display scaling, full keyboard/theme coverage, installed upgrade, and clean installation remain pending in #42. PR #40 remains a draft; stable remains v0.3.0 and v0.4 is unreleased.
