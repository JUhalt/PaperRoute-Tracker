...
The v0.4.0 version metadata, candidate notes, and user documentation are aligned. A local candidate passed **478 tests, with no failures or skips**, and built with no warnings or errors; [independent CI also passed](https://github.com/JUhalt/PaperRoute-Tracker/actions/runs/34706123322). Installer, full update package, and portable ZIP versions, payloads, local feeds, and checksums were verified. The installer is currently unsigned.

See the [candidate notes](https://github.com/JUhalt/PaperRoute-Tracker/blob/021cd0afdda1c66d21fc7ad78119e2012365983b/docs/releases/0.4.0.md), [packaging procedure](https://github.com/JUhalt/PaperRoute-Tracker/blob/021cd0afdda1c66d21fc7ad78119e2012365983b/ManualCertification/v0.4-Release-Packaging.md), and [checkpoint evidence and demo instructions](https://github.com/JUhalt/PaperRoute-Tracker/blob/021cd0afdda1c66d21fc7ad78119e2012365983b/ManualCertification/v0.4-Development-Checkpoint.md). Native Windows display scaling, full keyboard/theme coverage, installed upgrade, and clean installation remain pending in [release gate #42](https://github.com/JUhalt/PaperRoute-Tracker/issues/42). **PR #40 remains a draft; v0.4 is unreleased and stable downloads remain v0.3.0.**
