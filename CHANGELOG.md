...
The v0.5.0-rc.1 candidate is tracked in [#27](https://github.com/JUhalt/PaperRoute-Tracker/issues/27) and [release certification #52](https://github.com/JUhalt/PaperRoute-Tracker/issues/52). v0.5.0-rc.2 replaces it for final certification, adding the ampersand fix and the updated roadmap in the User Guide. See the [preview guide](docs/REVIEWER_RESPONSE_PREVIEW.md). v0.4.0 remains the current Stable release while final certification is completed.
